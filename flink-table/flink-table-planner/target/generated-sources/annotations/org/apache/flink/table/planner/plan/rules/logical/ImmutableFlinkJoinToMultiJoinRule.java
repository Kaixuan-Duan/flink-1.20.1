...
/**
 * {@code ImmutableFlinkJoinToMultiJoinRule} contains immutable implementation classes generated from
 * abstract value types defined as nested inside {@link FlinkJoinToMultiJoinRule}.
 * @see ImmutableFlinkJoinToMultiJoinRule.Config
 */
@Generated(from = "FlinkJoinToMultiJoinRule", generator = "Immutables")
@SuppressWarnings({"all"})
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
public final class ImmutableFlinkJoinToMultiJoinRule {
  private ImmutableFlinkJoinToMultiJoinRule() {}

  /**
   * Immutable implementation of {@link FlinkJoinToMultiJoinRule.Config}.
   * <p>
   * Use the builder to create immutable instances:
   * {@code ImmutableFlinkJoinToMultiJoinRule.Config.builder()}.
   */
  @Generated(from = "FlinkJoinToMultiJoinRule.Config", generator = "Immutables")
  @Immutable
  @CheckReturnValue
  public static final class Config
      implements FlinkJoinToMultiJoinRule.Config {
    private final RelBuilderFactory relBuilderFactory;
    private final @Nullable String description;
    private final RelRule.OperandTransform operandSupplier;

    private Config(ImmutableFlinkJoinToMultiJoinRule.Config.Builder builder) {
    ...
    private RelBuilderFactory relBuilderFactoryInitialize() {
      return FlinkJoinToMultiJoinRule.Config.super.relBuilderFactory();
    }

    private RelRule.OperandTransform operandSupplierInitialize() {
      return FlinkJoinToMultiJoinRule.Config.super.operandSupplier();
    }
    ...
    /**
     * Copy the current immutable object by setting a value for the {@link FlinkJoinToMultiJoinRule.Config#relBuilderFactory() relBuilderFactory} attribute.
     * A shallow reference equality check is used to prevent copying of the same value by returning {@code this}.
     * @param value A new value for relBuilderFactory
     * @return A modified copy of the {@code this} object
     */
    public final ImmutableFlinkJoinToMultiJoinRule.Config withRelBuilderFactory(RelBuilderFactory value) {
      if (this.relBuilderFactory == value) return this;
      RelBuilderFactory newValue = Objects.requireNonNull(value, "relBuilderFactory");
      return new ImmutableFlinkJoinToMultiJoinRule.Config(newValue, this.description, this.operandSupplier);
    }

    /**
     * Copy the current immutable object by setting a value for the {@link FlinkJoinToMultiJoinRule.Config#description() description} attribute.
    ...
    public final ImmutableFlinkJoinToMultiJoinRule.Config withDescription(@Nullable String value) {
      ...
      return new ImmutableFlinkJoinToMultiJoinRule.Config(this.relBuilderFactory, value, this.operandSupplier);
    }

    /**
     * Copy the current immutable object by setting a value for the {@link FlinkJoinToMultiJoinRule.Config#operandSupplier() operandSupplier} attribute.
     * A shallow reference equality check is used to prevent copying of the same value by returning {@code this}.
     * @param value A new value for operandSupplier
     * @return A modified copy of the {@code this} object
     */
    public final ImmutableFlinkJoinToMultiJoinRule.Config withOperandSupplier(RelRule.OperandTransform value) {
      if (this.operandSupplier == value) return this;
      RelRule.OperandTransform newValue = Objects.requireNonNull(value, "operandSupplier");
      return new ImmutableFlinkJoinToMultiJoinRule.Config(this.relBuilderFactory, this.description, newValue);
    }
    ...
    public boolean equals(@Nullable Object another) {
      ...
      return another instanceof ImmutableFlinkJoinToMultiJoinRule.Config
          && equalTo((ImmutableFlinkJoinToMultiJoinRule.Config) another);
    }

    private boolean equalTo(ImmutableFlinkJoinToMultiJoinRule.Config another) {
    ...
    /**
     * Creates an immutable copy of a {@link FlinkJoinToMultiJoinRule.Config} value.
    ...
    public static ImmutableFlinkJoinToMultiJoinRule.Config copyOf(FlinkJoinToMultiJoinRule.Config instance) {
      if (instance instanceof ImmutableFlinkJoinToMultiJoinRule.Config) {
        return (ImmutableFlinkJoinToMultiJoinRule.Config) instance;
      }
      return ImmutableFlinkJoinToMultiJoinRule.Config.builder()
          .from(instance)
          .build();
    }

    /**
     * Creates a builder for {@link ImmutableFlinkJoinToMultiJoinRule.Config Config}.
     * <pre>
     * ImmutableFlinkJoinToMultiJoinRule.Config.builder()
     *    .relBuilderFactory(org.apache.calcite.tools.RelBuilderFactory) // optional {@link FlinkJoinToMultiJoinRule.Config#relBuilderFactory() relBuilderFactory}
     *    .description(String | null) // nullable {@link FlinkJoinToMultiJoinRule.Config#description() description}
     *    .operandSupplier(org.apache.calcite.plan.RelRule.OperandTransform) // optional {@link FlinkJoinToMultiJoinRule.Config#operandSupplier() operandSupplier}
     *    .build();
     * </pre>
     * @return A new Config builder
     */
    public static ImmutableFlinkJoinToMultiJoinRule.Config.Builder builder() {
      return new ImmutableFlinkJoinToMultiJoinRule.Config.Builder();
    }

    /**
     * Builds instances of type {@link ImmutableFlinkJoinToMultiJoinRule.Config Config}.
    ...
    public static final class Builder {
      ...
      /**
       * Fill a builder with attribute values from the provided {@code org.apache.flink.table.planner.plan.rules.logical.FlinkJoinToMultiJoinRule.Config} instance.
       * @param instance The instance from which to copy values
       * @return {@code this} builder for use in a chained invocation
       */
      @CanIgnoreReturnValue 
      public final Builder from(FlinkJoinToMultiJoinRule.Config instance) {
        Objects.requireNonNull(instance, "instance");
        from((Object) instance);
        return this;
      }
      ...
      /**
       * Initializes the value for the {@link FlinkJoinToMultiJoinRule.Config#relBuilderFactory() relBuilderFactory} attribute.
       * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link FlinkJoinToMultiJoinRule.Config#relBuilderFactory() relBuilderFactory}.</em>
      ...
      /**
       * Initializes the value for the {@link FlinkJoinToMultiJoinRule.Config#description() description} attribute.
      ...
      /**
       * Initializes the value for the {@link FlinkJoinToMultiJoinRule.Config#operandSupplier() operandSupplier} attribute.
       * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link FlinkJoinToMultiJoinRule.Config#operandSupplier() operandSupplier}.</em>
      ...
      /**
       * Builds a new {@link ImmutableFlinkJoinToMultiJoinRule.Config Config}.
       * @return An immutable instance of Config
       * @throws java.lang.IllegalStateException if any required attributes are missing
       */
      public ImmutableFlinkJoinToMultiJoinRule.Config build() {
        return new ImmutableFlinkJoinToMultiJoinRule.Config(this);
      }
    }
  }
}
