...
public interface FlinkSqlParserImplConstants {
  ...
  int DATABASES = 696;
  int DISTRIBUTED = 697;
  int DISTRIBUTION = 698;
  int DRAIN = 699;
  int ENFORCED = 700;
  int ESTIMATED_COST = 701;
  int EXTENDED = 702;
  int FUNCTIONS = 703;
  int FRESHNESS = 704;
  int HASH = 705;
  int IF = 706;
  int JSON_EXECUTION_PLAN = 707;
  int JAR = 708;
  int JARS = 709;
  int JOB = 710;
  int JOBS = 711;
  ...
  int WATERMARK = 744;
  int WATERMARKS = 745;
  int UNSIGNED_INTEGER_LITERAL = 746;
  int APPROX_NUMERIC_LITERAL = 747;
  int DECIMAL_NUMERIC_LITERAL = 748;
  int EXPONENT = 749;
  int HEXDIGIT = 750;
  int WHITESPACE = 751;
  int BINARY_STRING_LITERAL = 752;
  int QUOTED_STRING = 753;
  int PREFIXED_STRING_LITERAL = 754;
  int UNICODE_STRING_LITERAL = 755;
  int CHARSETNAME = 756;
  int BIG_QUERY_DOUBLE_QUOTED_STRING = 757;
  int BIG_QUERY_QUOTED_STRING = 758;
  int UNICODE_QUOTED_ESCAPE_CHAR = 759;
  int LPAREN = 760;
  int RPAREN = 761;
  int LBRACE_D = 762;
  int LBRACE_T = 763;
  ...
  int HINT_BEG = 800;
  int COMMENT_END = 801;
  int SINGLE_LINE_COMMENT = 804;
  int FORMAL_COMMENT = 805;
  int MULTI_LINE_COMMENT = 806;
  int BRACKET_QUOTED_IDENTIFIER = 808;
  int QUOTED_IDENTIFIER = 809;
  int BACK_QUOTED_IDENTIFIER = 810;
  int BIG_QUERY_BACK_QUOTED_IDENTIFIER = 811;
  int HYPHENATED_IDENTIFIER = 812;
  int IDENTIFIER = 813;
  int COLLATION_ID = 814;
  int UNICODE_QUOTED_IDENTIFIER = 815;
  int LETTER = 816;
  int DIGIT = 817;
  int BEL = 818;
